...
class MMDSimulator(gym.Env):
    ...
    def print_metrics(self):
        ...
        print(f'Mean final log wealth eval vs env: {eval_mean_final_log_wealth:.3f} vs {env_mean_final_log_wealth:.3f}')
        print(f'Mean final wealth eval vs env: {eval_mean_final_wealth:.3f} vs {env_mean_final_wealth:.3f}')
        print(f'Mean return vol eval vs env: {eval_mean_return_vol:.3f} vs {env_mean_return_vol:.3f}')
        print(f'Mean sharpes eval vs env: {eval_mean_sharpe:.3f} vs {env_mean_sharpe:.3f}')
        print(f'Mean downside dev eval vs env: {eval_mean_downside_dev:.3f} vs {env_mean_downside_dev:.3f}')
        print(f'Mean sortino eval vs env: {eval_mean_sortino:.3f} vs {env_mean_sortino:.3f}')
